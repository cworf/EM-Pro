export default {
  q : {
      ...
      end: new Date(2016, 4, 9),
      desc: 'Political Rally',
      schedule : {
        doors_open: '10am',
        doors_close: '2pm',
        run_time: '12pm-2pm',
        load_in_time: '5/10/2016, 3pm',
        load_in_desc: 'all over the place',
        Sound_check_tech_time: '???',
      },
      venue : {
        venue: '_reference',
        stage: '_reference',
      ...
      audio_notes : {
        ...
        'Mixes required': 'thing',
        'Number of inputs/stageplot/input list': 'thing',
      ...
      video_notes : {
        ...
        'Video Content Details': 'thing',
        'Video power distro/service': 'thing',
        'Video Subcontractors needed': 'thing',
        'Video Subrentals needed': 'thing',
      },
      backline_notes : {
        'Backline description/needs': 'thing',
        'Backline Subcontractors needed': 'thing',
        'Backline Subrentals needed': 'thing',
      },
      crew_notes : {
        'Soft goods/deco description': 'thing',
        'Hospitality description': 'thing',
        'Stagehands/Techs needs description': 'thing',
        'Possible gear/labor conflicts': 'thing',
        'Banner or advertising available': 'thing',
        'Rain/Weather Backup Plan': 'thing',
      },
